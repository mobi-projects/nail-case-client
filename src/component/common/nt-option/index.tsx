...
const OptionVariants = cva(
	" flex items-center justify-center border-[1px] border-transparent px-[24px] text-center text-PB100 focus-visible:outline-none isabled:border-none disabled:bg-Gray10",
	{
		variants: {
			size: {
				medium:
